...
var CreateButton = function (props) {
    ...
    return isSmall ? (react_1.default.createElement(core_1.Fab, __assign({ component: react_router_dom_1.Link, color: "primary", className: classnames_1.default(classes.floating, className), to: basePath + "/create", "aria-label": label && translate(label) }, Button_1.sanitizeButtonRestProps(rest)), icon)) : (react_1.default.createElement(Button_1.default, __assign({ component: react_router_dom_1.Link, to: basePath + "/create", className: className, label: label }, rest), icon));
};
