...
var DeleteWithUndoButton = function (props) {
    ...
    var _d = ra_core_1.useDelete(resource, record.id, record, {
    ...
    return (react_1.default.createElement(Button_1.default, __assign({ onClick: handleDelete, disabled: loading, label: label, className: classnames_1.default('ra-delete-button', classes.deleteButton, className), key: "button" }, rest), icon));
};
